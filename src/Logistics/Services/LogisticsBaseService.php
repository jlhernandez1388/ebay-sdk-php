...
/**
 * Base class for the Logistics service.
 */
class LogisticsBaseService extends \DTS\eBaySDK\Services\BaseRestService
{
    /**
     * @var array $endPoints The API endpoints.
     */
    protected static $endPoints = [
        'sandbox'    => 'https://api.sandbox.ebay.com/sell/logistics',
        'production' => 'https://api.ebay.com/sell/logistics'
    ];
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DTS\eBaySDK\Logistics\Services\LogisticsService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
